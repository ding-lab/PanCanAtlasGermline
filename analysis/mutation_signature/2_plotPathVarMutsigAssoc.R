...
fn = 'out/pan10389_germlineAssocWithmutSignatureHeatmap.pdf'
...
p = p + geom_text_repel(aes(label=ifelse(FDR<0.05,as.character(signature),NA)))
p = p + getPCACancerColor()
...
fn = 'out/pan10389_germlineAssocWithmutSignatureByGene.pdf'
ggsave(fn,h=8,useDingbat=F)
